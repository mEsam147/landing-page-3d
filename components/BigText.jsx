...
const BigText = () => {
  ...
  return (
    <section
      ref={container}
      /* تم تغيير items-center إلى items-end و إضافة pb-20 لنزول النص للأسفل */
      className="w-screen min-h-screen overflow-hidden bg-[#2D1B14] text-[#D2B48C] flex items-end justify-center pb-20 md:pb-32"
    >
      <h2 className="grid w-full gap-[3vw] py-10 text-center font-black uppercase leading-[0.7]">
        {/* السطر الأول */}
        <div className="word text-[32vw]">Pure</div>
