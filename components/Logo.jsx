...
const Logo = ({ ...props }) => {
  return (
    <svg
      ...
      viewBox="0 0 200 80"
      className={clsx('group', props.className)}
      aria-labelledby="coffee-logo-title"
    >
      <title id="coffee-logo-title">Pure Roast Coffee</title>

      {/* تعريف الأنيميشن السائل (يشبه تموج القهوة) */}
      <defs>
        <clipPath id="clip_pure">
          <rect width="200" height="80" fill="currentColor" />
        </clipPath>
      </defs>

      <g clipPath="url(#clip_pure)">
        <mask
          id="mask_coffee"
          style={{ maskType: 'alpha' }}
          width="300"
          ...
          maskUnits="userSpaceOnUse"
        >
          {/* الأنيميشن السائل عند التحويم (Hover) */}
          <g className="transition-transform duration-700 ease-in-out group-hover:translate-y-[60%]">
            <path
              fill="white"
              d="M0 40 Q 50 20, 100 40 T 200 40 V 120 H 0 Z"
            ...
            >
              <animate
                ...
                values="M0 40 Q 50 20, 100 40 T 200 40 V 120 H 0 Z;
                        M0 40 Q 50 60, 100 40 T 200 40 V 120 H 0 Z;
                        M0 40 Q 50 20, 100 40 T 200 40 V 120 H 0 Z"
              />
            </path>
          </g>
        </mask>

        {/* النص الرئيسي للعلامة التجارية */}
        <g fill="currentColor" className="font-black">
          <text
            x="50%"
            y="60%"
            textAnchor="middle"
            className="text-4xl uppercase tracking-tighter"
        ...
        {/* الطبقة التي تظهر عند الـ Hover (تأثير ملء القهوة) */}
        <g mask="url(#mask_coffee)" fill="#D2B48C">
          <text
            x="50%"
            y="60%"
            textAnchor="middle"
